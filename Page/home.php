        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
			...
			if ($_SESSION['Level'] == 0)
			{
              ...
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="formco.php">Connexion</a>
            </li>';
			}
			else {
				echo '<li class="nav-item mx-0 mx-lg-1">
			...
			{
				echo '<li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="formajout.php">Ajout</a>
            </li>';
				echo '<li class="nav-item mx-0 mx-lg-1">
