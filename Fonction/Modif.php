<?php	
			   ...
			   /* Inclusion du fichier de fonctions */
				...
				else //modification bdd
				{
					$query=$db->prepare('UPDATE blog SET Titre=:Titre, date=NOW(), Chapo= :Chapo, Contenu= :Contenu, image=:image, id_Admin= :id_Admin WHERE id_Blog =:id_Blog');
